...
for i in N:
    ...
    X_train_sliced, y_train_sliced = expand_training_data(X_train_all[:i], y_train_all[:i], window_size, step_size)
    ...
    for Xtrial, Ytrial in zip(X_test, y_test):
        newX, newY = expand_training_data([Xtrial], [Ytrial], window_size, step_size)
